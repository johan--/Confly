...
//            isBound = true;
	...
	public void libraryButtonClick() {
		...
		ls.installBook("file://android_asset/books/9781448126361.epub");
...
//		ls.startDownload("http://skytree21.host.whoisweb.net/books/Saadi.epub","http://skytree21.host.whoisweb.net/books/Saadi.jpg","سعدی‎","سعدی‎");
//		ls.startDownload("http://skytree21.host.whoisweb.net/books/Doctor.epub","http://skytree21.host.whoisweb.net/books/Doctor.jpg","시골의사 박경철의 자기혁명","박경철");
	}
...
//			return vw;
		...
		private RelativeLayout makeContentView(BookInformation bi,int vw, int vh) {
			...
			String coverName = bi.fileName;
			coverName = coverName.replace(".epub", ".jpg");
			String coverPath = SkySetting.getStorageDirectory() + "/books/"+coverName;

...
//		Bitmap pagesStack = 	BitmapFactory.decodeFile(getResources().getResourceName(R.drawable.pagesstack));
//		Bitmap pagesCenter = 	BitmapFactory.decodeFile(getResources().getResourceName(R.drawable.pagescenter));
...
//		fv.setPagesStackImage(pagesStack);
		...
		fv.setBaseDirectory(Helper.getBookDirectory()+"/"+fileName);

...
final class DisplayBitmapTask implements Runnable {
	...
	public DisplayBitmapTask(Bitmap bitmap, ImageLoadingInfo imageLoadingInfo, ImageLoaderEngine engine, LoadedFrom loadedFrom, ProgressBar progressBar) {
		this.bitmap = bitmap;
		imageUri = imageLoadingInfo.uri;
		imageViewRef = imageLoadingInfo.imageViewRef;
		memoryCacheKey = imageLoadingInfo.memoryCacheKey;
	...
	public void run() {
		...
		if (imageView == null) {
			...
			Bitmap displayedBitmap = displayer.display(bitmap, imageView, loadedFrom, progressBar);
